 ...
 *
 * Created for WordPress Version 4.9.5
 *
...
* @method void wp_set_comment_cookies (\WP_Comment $comment, object $user) https://developer.wordpress.org/reference/functions/wp_set_comment_cookies
